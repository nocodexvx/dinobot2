...
-- ✅ 17 índices de performance (15 originais + 2 melhorias)
-- ✅ Row Level Security (RLS) em todas as tabelas
-- ✅ Constraints e validações
-- ✅ Triggers para updated_at
-- ✅ Políticas de segurança otimizadas
--
-- VERSÃO: VALIDADA E OTIMIZADA
...
CREATE TABLE IF NOT EXISTS public.bots (
    ...
    payment_private_token text,
    payment_webhook_secret text,
    payment_method_message text DEFAULT 'Escolha o método de pagamento abaixo:',
    payment_method_button_text text DEFAULT '💠 Pagar com Pix',
    pix_main_message text DEFAULT '🌟 Você selecionou o seguinte plano:',
    pix_media_url text,
...
CREATE TABLE IF NOT EXISTS public.plans (
    ...
    order_bump_enabled boolean DEFAULT false NOT NULL,
...
-- =====================================================
-- 🔗 SEÇÃO 2: ÍNDICES DE PERFORMANCE (17 ÍNDICES)
-- =====================================================
...
-- 🆕 MELHORIA: Índice composto para consultas por plano e status
CREATE INDEX IF NOT EXISTS idx_subscriptions_plan_status ON public.subscriptions(plan_id, status);
...
-- 🆕 MELHORIA: Índice para consultas de auditoria por tipo de recurso
...
-- =====================================================
-- ✅ SCRIPT VALIDADO E OTIMIZADO!
-- =====================================================
-- 
-- 🎉 BANCO DE DADOS DINOBOT VALIDADO E OTIMIZADO!
-- 
-- ✅ 7 tabelas principais criadas
-- ✅ Relacionamentos (foreign keys) configurados
-- ✅ 17 índices de performance adicionados (15 originais + 2 melhorias)
...
-- 1. Índice composto idx_subscriptions_plan_status
-- 2. Índice para auditoria idx_audit_logs_resource
-- 
